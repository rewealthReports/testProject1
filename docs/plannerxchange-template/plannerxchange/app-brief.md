...
12. Does the app need to send outbound email (for example, delivering a questionnaire link, a completed-workflow confirmation, or a report)? If yes, declare `email.send` in the manifest permissions and read `docs/builder-spec/outbound-email-v1.md` before writing any email-related code.
